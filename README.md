...
However, if you want to use a pre-compiled file, you can fetch it from [unpkg](https://unpkg.com). The development version is available at [https://unpkg.com/browse/oneid-sdk@1.0.13/src/index.ts](https://unpkg.com/browse/oneid-sdk@1.0.13/src/index.ts).
